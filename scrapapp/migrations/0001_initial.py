    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(upload_to='scrappics')),
                ('price', models.CharField(max_length=200)),
                ('place', models.CharField(max_length=200)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(choices=[('reject', 'reject'), ('pending', 'pending'), ('accpet', 'accept')], default='pending', max_length=200)),
